...
```mermaid
sequenceDiagram
    participant Perron as Familia Perron
    participant Warren as Ed & Lorraine Warren
    participant Clero as Iglesia Católica
    Perron->>Warren: Solicitan investigación (1973)
    Warren->>Perron: Recopilación de testimonios
    Warren->>Perron: Detección de Bathsheba
    Warren->>Clero: Recomiendan exorcismo
    Perron-->>Warren: Rechazan exorcismo
    Perron->>Perron: Abandono de la casa (1980)
```
