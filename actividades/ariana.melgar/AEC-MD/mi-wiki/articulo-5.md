...
```mermaid
flowchart TD
    A[David Glatzel - Síntomas 1980] --> B[Familia contacta Warren]
    B --> C[Serie de exorcismos]
    C --> D[Arne desafía al demonio]
    D --> E[Supuesta transferencia]
    E --> F[16 Feb 1981 - Homicidio]
    F --> G[Arresto de Arne]
    G --> H[Defensa por posesión]
    H --> I[Juez rechaza argumento]
    I --> J[Condena: 10-20 años]
    J --> K[Liberación 1986]
    C --> L[Warren documentan caso]
    L --> M[Publicidad mediática]
    M --> N[Película 2021]
```
