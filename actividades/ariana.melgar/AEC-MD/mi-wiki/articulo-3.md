...
```mermaid
flowchart TD
  A[Donna - Estudiante] --> B[Eventos extraños]
  B --> C[Consulta médium]
  C --> D[Annabelle Higgins]
  B --> E[Contacta a los Warren]
  E --> F[Identifican entidad demoníaca]
  F --> G[Traslado al museo]
  G --> H[Exhibición en caja de vidrio]
  H --> I[Inspiración para películas]
```
