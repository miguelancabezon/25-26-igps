...
```mermaid
flowchart TD
  A[Asesinatos DeFeo - 1974] --> B[Casa a la venta]
  B --> C[Familia Lutz compra - 1975]
  C --> D[28 días de actividad]
  D --> E[Abandono de la casa]
  E --> F[Contacto con Warren]
  F --> G[Investigación Warren]
  G --> H[Libro y películas]
  F --> I[William Weber admite fraude]
  H --> J[Controversia pública]
  I --> J
```
