...
```mermaid
flowchart TD
GT[Guilherme Tâmega] -->|Potencia| Campeonatos
Campeonatos -->|Legado| Brasil
```
...
<details><summary>Logros destacados</summary>
...
```mermaid
sequenceDiagram
Rinder->>Ola: Entrada vertical
Ola->>Rinder: Tubo profundo
Rinder->>Competición: Maniobra invert
Competición->>Rinder: Título mundial
```
...
← Anterior [Spots del mundo](articulo.md)