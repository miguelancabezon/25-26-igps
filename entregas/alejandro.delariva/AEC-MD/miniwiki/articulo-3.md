...
**Ruta:** Inicio > Representación > Distribución de Frecuencias
...
## Introducción
Una **tabla de frecuencias** es el primer espejo de un conjunto de datos: revela cuántas veces aparece cada valor o intervalo. Junto con los histogramas, ayuda a detectar forma (simetría, sesgo), dispersión y posibles atípicos. Aprenderás a construir tablas absolutas, relativas y acumuladas, y a elegir el número de clases para un histograma funcional. Vinculamos con [Variables](./articulo-2.md) para confirmar escalas, con [Medidas](./articulo-4.md) para resumir numéricamente, y con [Fundamentos](./articulo-1.md) y [Aplicaciones](./articulo-5.md) para contextualizar decisiones en ingeniería.
...
## Navegación
← [Tipos de Datos y Variables](./articulo-2.md) | [Medidas de Centralización y Dispersión](./articulo-4.md) →  
